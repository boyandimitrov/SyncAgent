...
const schema = [
    ...
    {"name":"transaction_created_year","type":"int64","system":true, subtype: "year", label : "Транзакция (година)", "distinct" : {"table" : "VIEW", "field" : "transaction_created_year"}},
    ...
    {"name" : "market_name", "type" : "string", label : "Верига"},
    {"name" : "shop_name", "type" : "string", label : "Магазин"},
    {"name" : "promotion_name", "type" : "string", label : "Промоция"},
